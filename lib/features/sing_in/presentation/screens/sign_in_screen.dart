...
import 'package:expense_tracker/features/sing_in/presentation/widgets/custom_text_field.dart';
import 'package:expense_tracker/features/sing_in/presentation/widgets/psw_text_field.dart';
...
class SignInScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final provider = Provider.of<SingInProvider>(context);
    return Scaffold(
      body: Center(
        child: Column(
